...
public class ValorTasaInteresBeanDAO implements DAO<Long, ValorTasaInteres> {
	...
	public ValorTasaInteres create(ValorTasaInteres t) {
		this.em.persist(t);
		return t;
	}

	public void delete(ValorTasaInteres t) {
		t = this.em.merge(t);
		this.em.remove(t);
	}
	...
	public ValorTasaInteres update(ValorTasaInteres t) {
		return this.em.merge(t);
	}

	public List<ValorTasaInteres> findAll() {
		List<ValorTasaInteres> list = null;
		CriteriaQuery cq = this.em.getCriteriaBuilder().createQuery();
		cq.select(cq.from(ValorTasaInteres.class));
		list = this.em.createQuery(cq).getResultList();
		return list;
	}

	public List<ValorTasaInteres> findByNamedQuery(String namedQueryName) {
	...
	public List<ValorTasaInteres> findByNamedQuery(String queryName,
			int resultLimit) {
